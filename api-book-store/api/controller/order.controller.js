...
const Model = require('../model/order/order.model.js')
...
exports.create = (req, res) => {
    util.upload_center(req, res, async (result) => {
        ...
        const create = await Model.createOrderFullInformation(validate.data)
...
exports.removeByOrderId = (req, res) => {
    util.upload_center(req, res, async (result) => {
        ...
        const removeById = await Model.removeOrder(orderId)
